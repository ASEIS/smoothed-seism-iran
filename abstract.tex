...
% For completeness, we also consider the partial contribution of the seismic zones of Zagros to the southwest, and the south-central and southeastern Iranian seismic zones. 
...
models defined based on the assumption that damage occurs above earthquake magnitude thresholds of $M_w$ greater than 4.5 and 5.0, depending on the type of construction, 
 % for unreinforced and reinforced structures, respectively. We 
