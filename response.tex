...
\response{%
Ricardo, I couldn't find any paper or report as a reference in their website. Please see. 
}
...
\response{%
Added. Thanks. (No need to add more explanation. Please see the email.)
}
...
\response{In revised version. We used backbone and plus and minus one standard deviation as three GMPEs. }
