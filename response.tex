...
\comment{22}{%
line 300 -> allows one to draw information ? allows to draw information 
}
\response{Response will be here.}
...
\comment{58}{%
P37: 10 percent of probability -> 10 percent probability }
\response{Response will be here.}
...
\comment{60}{%
p 39 ? figure 11 -> p 41 ? figure 12 -> Can you include curves or points for the other studies in Table 3?}
\response{Response will be here.}
