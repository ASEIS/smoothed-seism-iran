...
% To assess the seismic hazard for this region, we use the smoothed seismicity method introduced by \citep{Frankel1995}. In our analysis, we assume earthquake hazard in northern Iran to be dominated by the seismic zones of Azerbaijan, Alborz, and Kopeh-Dagh; but for completeness, we also consider the partial contribution of the areas of Zagros and the central-east seismic zones within our domain of interest (see Figure \ref{fig:Iran}).
...
has a significant population density 
...
% in which many destructive earthquakes have been reported.
