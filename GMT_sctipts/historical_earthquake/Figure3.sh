...
awk '{print $2,$3,$1,($4^3.2)/1000}' historical.txt|psxy -Sc -G51/51/255 -W1 -Ccolors.cpt -R$REGION $PROJ -K -O >> $0.ps
...
cat << EOF | awk '{print $2,$3,$1,($4^3.2)/1000}'|psxy -Sc -G51/51/255 -W1 -Ccolors.cpt -R$REGION $PROJ -K -O >> $0.ps
900 60 38     5
900 60 38.5   6
900 60 38.9   7
900 60 39.6   8
