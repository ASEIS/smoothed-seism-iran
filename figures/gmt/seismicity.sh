...
gmt psbasemap -R41.5/63.5/32/42 -JM5i -BWnes -Ba2f1 -Y8i -V -P -K > ${PSNAME}
...
gmt psbasemap -R -J -BWneS -Ba2f1 -Y-3.2i -V -P -O -K >> ${PSNAME}
gmt grdimage mytopo.grd -R -J -Bwnes -Imytopo.norm -Cgray -t50 -V -O -K >> ${PSNAME}
gmt pscoast -R -J -B -Dh -W0.25p -N1/0.25p -A500 -V -P -O -K >> ${PSNAME}
gmt pscoast -R -J -B -Slightblue -A500 -Dh -W0.25p -V -P -O -K >> ${PSNAME}
...
64.1 38.3 8 0 1 ML Magnitude
65.6 37.5 8 0 1 ML 5.0
65.6 36.7 8 0 1 ML 6.0
65.6 35.7 8 0 1 ML 7.0
65.6 34.5 8 0 1 ML 8.0
END

# Year Color Scale
# ------------------------------------------------------------------------------

gmt psscale -Chistorical.cpt -D5.3i/4.2i/1.8i/0.2i -B300 -E -O >> ${PSNAME}
