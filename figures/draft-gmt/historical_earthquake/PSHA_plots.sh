...
awk '{print $2,$3,$1,($4*$4)/150}' historical.txt|psxy -Sc -G51/51/255 -W1 -Ccolors.cpt -R$REGION $PROJ -K -O >> $0.ps
psscale -D3.5i/4.2i/8i/0.15ih -Ba100:"Earthquake Time": -Ccolors.cpt -K -O >>  $0.ps
...
#awk '{print $9,$10}' complete_catalog_az_declustered.txt|psxy -Sc0.2 -G51/51/150  -W1 -R$REGION $PROJ -K -O >> $0.ps
